...
public class Queue {
	 ...
	 * 
	 * @param <b>initialSize</b>
	 *            The initial size of the new <em>Queue</em>.
	 */
	 ...
	 * 
	 * @param <b>q</b>
	 *            A reference to the object to add.
	 * @return <b>void</b>
	 */
	 ...
	 *         Returns <em>null</em> if the queue is empty.
	 */
	...
	/**
	 * This function allows arbitrary queue elements to be removed. Elements
	 * which are equal (according to the <em>equal</em> function) to the
	 * argument are removed from the queue. Note that this version of the
	 * function only removes the FIRST element found. Use the <em>removeAll</em>
	 * function to remove ALL elements equal to the argument.
	 * 
	 * @param <b>rem</b>
	...
	synchronized public boolean remove(Object rem) {
		...
		// PRAGMA [debug,osl.util.Queue] Log.println("<Queue.remove> Searching
		// for element: " + rem);
		...
		if (i == back)
			...
			// PRAGMA [debug,osl.util.Queue] Log.println("<Queue.remove> Element
			// not found, returning");
			return false;
